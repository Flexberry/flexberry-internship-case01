...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="ZdanieE.aspx.cs" Inherits="IIS.ThermoObject.ЗданиеE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlПлощадьВсехОТLabel" runat="server" Text="Площадь всех ОТ" EnableViewState="False">
</asp:Label>
<ac:DecimalTextBox runat="server" CssClass="descTxt" ID="ctrlПлощадьВсехОТ">
</ac:DecimalTextBox>
