...
namespace IIS.ThermoObjectTask6
{
    ...
    public class Здание : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ThermoObjectTask6.СетевойРайон fСетевойРайон;
        
        private IIS.ThermoObjectTask6.DetailArrayOfОбъектТеплопотребления fОбъектТеплопотребления;
        ...
        [PropertyStorage(new string[] {
                "СетевойРайон"})]
        [NotNull()]
        public virtual IIS.ThermoObjectTask6.СетевойРайон СетевойРайон
        {
            get
            {
                ...
                IIS.ThermoObjectTask6.СетевойРайон result = this.fСетевойРайон;
        ...
        public virtual IIS.ThermoObjectTask6.DetailArrayOfОбъектТеплопотребления ОбъектТеплопотребления
        {
            get
            {
                ...
                {
                    this.fОбъектТеплопотребления = new IIS.ThermoObjectTask6.DetailArrayOfОбъектТеплопотребления(this);
                }
                IIS.ThermoObjectTask6.DetailArrayOfОбъектТеплопотребления result = this.fОбъектТеплопотребления;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗданиеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗданиеE", typeof(IIS.ThermoObjectTask6.Здание));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗданиеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗданиеL", typeof(IIS.ThermoObjectTask6.Здание));
                }
            }
        }
    }
